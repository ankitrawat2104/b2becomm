    ...
    content: '\
      <div class="page no-navbar no-toolbar no-swipeback">\
        <div class="page-content login-screen-content">\
          <div class="login-screen-header"><div><a href="#" class="link back"><i class="f7-icons size-28">arrow_left</i></a><img src="img/logo-white.png" class="logo"></div><div class="title-reg">Register</div></div>\
          <form>\
            <div class="card card-outline">\
              <div class="card-header">Firm Details</div>\
              <div class="card-content card-content-padding">\
                <div class="form-group"><label>Shop/Firm Name<span class="text-danger">*</span></label><input type="text" class="form-control"></div>\
                <div class="form-group"><label>GSTIN No.<span class="text-danger">*</span></label><input type="text" class="form-control"></div>\
              </div>\
            </div>\
            <div class="card card-outline">\
              <div class="card-header">Personal Details</div>\
              <div class="card-content card-content-padding">\
                <div class="row"><div class="col-50"><div class="form-group"><label>First Name<span class="text-danger">*</span></label><input type="text" class="form-control"></div></div><div class="col-50"><div class="form-group"><label>Last Name<span class="text-danger">*</span></label><input type="text" class="form-control"></div></div></div>\
                <div class="form-group"><label>Mobile Number<span class="text-danger">*</span></label><input type="text" class="form-control"></div>\
                <div class="form-group"><label>Email<span class="text-danger">*</span></label><input type="text" class="form-control"></div>\
              </div>\
            </div>\
            <div class="card card-outline">\
              <div class="card-header">Address</div>\
              <div class="card-content card-content-padding">\
                <div class="form-group"><label>Street Address<span class="text-danger"></span></label><input type="text" class="form-control"></div>\
                <div class="row"><div class="col-50"><div class="form-group"><label>State<span class="text-danger"></span></label><input type="text" class="form-control"></div></div><div class="col-50"><div class="form-group"><label>District<span class="text-danger"></span></label><input type="text" class="form-control"></div></div></div>\
                <div class="row"><div class="col-50"><div class="form-group"><label>Tehsil<span class="text-danger"></span></label><input type="text" class="form-control"></div></div><div class="col-50"><div class="form-group"><label>Zip Code<span class="text-danger"></span></label><input type="text" class="form-control"></div></div></div>\
              </div>\
            </div>\
            <div class="list">\
            </div>\
            <div class="list">\
              <ul>\
                <li><a href="#" class="item-link list-button sigin-btn">Register</a></li>\
              </ul>\
              <div class="block-footer">\
                <p><a href="#" class="link back">Close</a></p>\
              </div>\
            </div>\
          </form>\
        </div>\
